     ...
     <div class="row tc_detail">
                       ...
                       <div class="main_body bg_img">
                        ...
                        <div class="header">
                            ...
                            <div class="college_name">Darul Quran Siddikia Kamil Madrasa
                                <div class="seriol_number"><?php print $test_id; ?></div><!--end of seriol_number-->
                        ...
                        <div class="contain"><p>I,with much pleasure, certify that <?php print $name; ?> was a student of this college.Hes/she duly has passed the HSC Examination under the board of Intermediate and Secondary Education,Jessore/National University held in the year of <?php print $seassion; ?> While he/she was in this college,his/her conduct was found to be satisfactory.So far as I know he/she never took part in any activities subversive to law and discipline of the college</p></div><!--end of contain-->
                     ...
                     <table width="285" border="0">
                        <tr>
                            ...
                            <td width="159" align="left" style="border-bottom:1px solid #a6ad8c;"><?php print $name; ?></td>
                        </tr>
                        <tr>
                            <td width="102" align="left">Father's Namet</td>
                            <td width="10" align="left">:</td>
                            <td width="159" align="left" style="border-bottom:1px solid #a6ad8c;"><?php print $father; ?></td>
                        </tr>
                        <tr>
                            <td width="102" align="left">Mother's Name</td>
                            <td width="10" align="left">:</td>
                            <td width="159" align="left" style="border-bottom:1px solid #a6ad8c;"><?php print $mother; ?></td>
                        </tr>
                        <tr>
                            <td width="102" align="left">Date of Barth</td>
                            <td width="10" align="left">:</td>
                            <td width="159" align="left" style="border-bottom:1px solid #a6ad8c;"><?php print $dob; ?></td>
                        </tr>
                        <tr>
                        <td width="102" align="left">Village</td>
                        <td width="10" align="left">:</td>
                        <td width="159" align="left" style="border-bottom:1px solid #a6ad8c;"><?php print $village; ?></td>
                        
                        </tr>
                        <tr>
                            <td width="102" align="left">Post Office</td>
                            <td width="10" align="left">:</td>
                            <td width="159" align="left" style="border-bottom:1px solid #a6ad8c;"><?php print $post; ?></td>
                        </tr>
                        <tr>
                            <td width="102" align="left">Upazilla</td>
                            <td width="10" align="left">:</td>
                            <td width="159" align="left" style="border-bottom:1px solid #a6ad8c;"><?php print $upazilla; ?></td>
                        </tr>
                        <tr>
                            <td width="102" align="left">Ditrict</td>
                            <td width="10" align="left">:</td>
                            <td width="159" align="left" style="border-bottom:1px solid #a6ad8c;"><?php print $district; ?></td>
                        </tr>
                        </table>
                        ...
                        <tr>
                            ...
                            <td width="10" align="left">:</td>
                            <td width="139" align="left" style="border-bottom:1px solid #a6ad8c;"><?php print $exam_name; ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="10" align="left">:</td>
                            <td width="139" align="left" style="border-bottom:1px solid #a6ad8c;"><?php print $reg_no; ?></td>
                        </tr>
                        <tr>
                            <td width="138" align="left">Seassion</td>
                            <td width="10" align="left">:</td>
                            <td width="139" align="left" style="border-bottom:1px solid #a6ad8c;"><?php print $seassion; ?></td>
                        </tr>
                        <tr>
                            <td width="138" align="left">Roll No</td>
                            <td width="10" align="left">:</td>
                            <td width="139" align="left" style="border-bottom:1px solid #a6ad8c;"><?php print $roll_no; ?></td>
                        </tr>
                        <tr>
                            <td width="138" align="left">Exam.Centre</td>
                            <td width="10" align="left">:</td>
                            <td width="139" align="left" style="border-bottom:1px solid #a6ad8c;"><?php print $ex_center; ?></td>
                        </tr>
                        <tr>
                            <td width="138" align="left">Group</td>
                            <td width="10" align="left">:</td>
                            <td width="139" align="left" style="border-bottom:1px solid #a6ad8c;"><?php print $group; ?></td>
                        </tr>
                        <tr>
                            <td width="138" align="left">G.P.A</td>
                            <td width="10" align="left">:</td>
                            <td width="139" align="left" style="border-bottom:1px solid #a6ad8c;"><?php print $gpa; ?></td>
                        </tr>
                        <tr>
                            <td width="138" align="left">Date of result publication</td>
                            <td width="10" align="left">:</td>
                            <td width="139" align="left" style="border-bottom:1px solid #a6ad8c;"><?php print $publish_date; ?></td>
                        </tr>
                        </table>
