<div id="page-wrapper">
            ...
            <ul class="nav nav-tabs">
              <li class="active"><a href="<?php echo base_url(); ?>/Admin/General_settings/gallery">Image List</a></li>
              <li><a href="<?php echo base_url(); ?>/Admin/General_settings/upload_image_gallery">Upload</a></li>
            </ul>
