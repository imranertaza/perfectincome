<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Nagad Deposit Request List</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										...
										{
										?>
                                        <tr class="odd gradeX" id="nagad_request_<?php print $rows->history_trans_nagad_id; ?>">
                                            <td><?php print get_field_by_id_from_table('users', 'username', 'ID', $rows->receiver_id); ?></td>
                                            <td><?php print $rows->sender_phone; ?></td>
                                            <td><?php print $rows->nagad_number; ?></td>
                                            <td><?php print $rows->transection_num; ?></td>
                                            ...
                                            <td class="center">
                                                ...
                                                <a href="<?php print base_url(); ?>admin_ut/deposit_request/change_status/1/<?php print $rows->history_trans_nagad_id; ?>" class="btn btn-primary take_margin" title="Edit">Approve</i></a>
                                                <a href="<?php print base_url(); ?>admin_ut/deposit_request/change_status/2/<?php print $rows->history_trans_nagad_id; ?>" class="btn btn-danger take_margin" title="Edit">Cancel</i></a>
                                                <?php }else { ?>
