                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                		...
                                		<div class="form-group">
                                            ...
                                            <input class="form-control" name="spon_id" type="text" list="spo_id" onchange="check_spon(this.value)" required>
                                            <datalist id="spo_id">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="ref_id" type="text" list="ref_id" onchange="check_username(this.value)" required>
                                            <datalist id="ref_id">
                                                <?php print get_username_as_list(); ?>
                                              </datalist>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="p_id" type="text" list="parent" onchange="parent_check(this.value)" required>
                                            <datalist id="parent">
                                                <?php print get_username_as_list(); ?>
                                              </datalist>
                                ...
                                <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="nodob" type="text" required>
