                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row" style="padding:20px;">
                                ...
                                <form method="post" action="<?php print base_url(); ?>classes/add_subject.html">
                                <table width="300" border="0" class="" id="dataTables-example">
                                  ...
                                  <tr>
                                    <td><input type="submit" class="btn btn-default btn btn-primary" name="add_subject" value="+ Add"></td>
                                  </tr>
                                </table>
								</form>
