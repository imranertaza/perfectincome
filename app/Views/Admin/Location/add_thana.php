<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Add Thana</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        ...
                        <form method="post" action="<?php echo base_url('Location/action_thana') ?>">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>Add Thana </label>
                                    <input class="form-control" name="thana" required>
                                </div>
                                <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-default btn btn-primary" name="add_thana">Add
                                </button>
                            </div>
                        </form>
                        <!-- /.col-lg-6 (nested) -->
