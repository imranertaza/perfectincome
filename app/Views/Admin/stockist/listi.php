                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX" id="std_<?php print $rows->ID; ?>">
                                            ...
                                            <td class="center">
                                            <a href="<?php print base_url(); ?>admin_area/stockist/view/<?php print $rows->ID; ?>.html" class="btn btn-primary take_margin" title="View"><i class="fa fa-fw"></i></a>
                                            <?php if ($this->functions->hasPermission('edit_std') == true) { ?>
                                            <a href="<?php print base_url(); ?>admin_area/stockist/edit/<?php print $rows->ID; ?>.html" class="btn btn-primary take_margin" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
                                            <?php } ?>
