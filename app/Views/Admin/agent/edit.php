<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit The Agent Info</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div id="success_report"><?php //if ($msg) { print $msg; }?></div>
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="fname" type="text" value="<?php print $row->f_name; ?>" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="lname" type="text" value="<?php print $row->l_name; ?>" required>
                           ...
                           <textarea class="form-control" name="addr" cols="5" rows="3" value="<?php print $row->address1; ?>" required></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea  class="form-control" name="per_addr" value="<?php print $row->address2; ?>" cols="5" rows="3" required></textarea>
                                            <p class="help-block">Please put your address</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Phone</label>
                                            <?php echo form_error('phone', '<p class="error">', '</p>'); ?>
                                            <input class="form-control" name="phone" type="text" value="<?php print $row->phn_no; ?>" required>
                                            <p class="help-block">Please put your phone</p>
                                        </div>
                                        <div class="form-group">
                                            <label>National ID </label>
                                            <?php echo form_error('nid', '<p class="error">', '</p>'); ?>
                                            <input class="form-control" name="nid" value="<?php print $row->nid; ?>" type="text">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="father" value="<?php print $row->father; ?>" type="text" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="mother" type="text" value="<?php print $row->mother; ?>" required>
                                ...
                                <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="post_code" value="<?php print $row->post; ?>" type="text" required>
                                            <p class="help-block">Please put your post code</p>
                                        </div>
                                		<div class="form-group">
                                            <label>Sponsor ID</label>
                                            <?php echo form_error('spon_id', '<p class="error">', '</p>'); ?>
                                            <input class="form-control" name="spon_id" value="<?php print $row->f_name; ?>" type="text" list="spo_id" onchange="check_spon(this.value)" required>
                                            <datalist id="spo_id">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php echo form_error('ref_id', '<p class="error">', '</p>'); ?>
                                            <input class="form-control" name="ref_id" type="text" value="<?php print $row->f_name; ?>" list="ref_id" onchange="check_username(this.value)" required>
                                            <datalist id="ref_id">
                                                <?php print get_username_as_list(); ?>
                                              </datalist>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="p_id" type="text" value="<?php print $row->f_name; ?>" list="parent" onchange="parent_check(this.value)" required>
                                            <datalist id="parent">
                                                <?php print get_username_as_list(); ?>
                                              </datalist>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="position" value="<?php print $row->f_name; ?>" id="hand" required>
                                            </select>
                                            <p class="help-block">Please choose a side to add</p>
                                        </div>
                                        <!--<div class="form-group">
                                            <label>User Type</label>
                                            <?php //echo form_error('u_type', '<p class="error">', '</p>'); ?>
                                            <select class="form-control" name="u_type" required>
                                                <option selected="selected" value="1">Administrative</option>
                                                <option value="2">Agent</option>
                                                <option value="3">Stockis</option>
                                ...
                                <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="non" type="text" value="<?php print $row->f_name; ?>" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="relation" class="form-control" value="<?php print $row->f_name; ?>" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="nodob" value="<?php print $row->f_name; ?>" type="text" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="banks" class="form-control" value="<?php print $row->f_name; ?>" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="account_no" value="<?php print $row->f_name; ?>" type="text" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="uname" value="<?php print $row->f_name; ?>" type="text" onchange="check_valid_username(this.value)" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="pass" value="<?php print $row->f_name; ?>" type="password" id="txtNewPassword" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="con_pass" value="<?php print $row->f_name; ?>" type="password" id="txtConfirmPassword" onChange="checkPasswordMatch();" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="email" value="<?php print $row->f_name; ?>" type="text" id="email" onchange="validate()" required>
                                            <p class="help-block" id="result">Please put your user email (it will be used for login)</p>
                                        </div>
                                        <div class="form-group">
                                            <label>User role <sup class="required">*</sup></label>
                                            <?php echo form_error('role', '<p class="error">', '</p>'); ?>
                                            <select class="form-control" name="role" required>
                                            	<?php $this->functions->role_list();  ?>
                                            </select>
                                        </div>
                                        <input type="submit" class="btn btn-default btn btn-primary" value="Update User" name="edit_user" />
                                </div>
                                </form>
                                <!-- /.col-lg-6 (nested) -->
                            </div>
