...
<header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
        ...
        <a href="<?php echo base_url(); ?>" class="logo me-auto me-lg-0"><img
                    src="<?php echo base_url(); ?>/assets/img/logo.png" alt="" class="img-fluid"></a>

        <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
                <li><a class="nav-link scrollto active" href="<?php echo base_url(); ?>">Home</a></li>
                <li><a class="nav-link scrollto" href="<?php print base_url(); ?>/details/page/package">Packages</a>
                </li>
                <li><a class="nav-link scrollto"
                       href="<?php print base_url(); ?>/details/page/incentives">Incentives</a></li>
                <li><a class="nav-link scrollto" href="<?php print base_url(); ?>/details/page/notice">Notice</a></li>
                <li><a class="nav-link scrollto" href="<?php print base_url(); ?>/details/page/about-us">About Us</a>
                </li>
                <li><a class="nav-link scrollto" href="<?php print base_url(); ?>/details/page/contact-us">Contact
                        Us</a></li>
            </ul>
