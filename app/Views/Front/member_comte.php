<div class="col-md-8">
    <div class="row">
        <div class="col-md-12">
        	<h1>Governing Body Member List</h1>
            ...
            <div class="row student_list">
                ...
                <?php if (!empty($image)) {?>
                <img src="<?php print base_url().$timthumb; ?>?src=<?php echo base_url().$tec_path.$image; ?>&amp;w=120&amp;h=110&amp;zc=1">
                <?php }else { ?>
                <img src="<?php print base_url().$timthumb; ?>?src=<?php echo base_url().$tec_path."no_thumb.jpg"; ?>&amp;w=120&amp;h=110&amp;zc=1">
                <?php } ?>
                </div>
                <div class="col-md-10">
                <h4><?php print $row->name; ?></h4>
				<p><?php print substr(strip_tags($row->description), 0, 150); ?></p>
                <a href="<?php print base_url(); ?>commitee/view/<?php print $row->tec_id; ?>">View Detail</a>
                </div>
            </div>
