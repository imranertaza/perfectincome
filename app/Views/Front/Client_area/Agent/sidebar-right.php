            ...
            <div class="head_teacher_comment">
                ...
                <div class="cart table-responsive">
                    ...
                    <?php if ($cart->totalItems() <= 0) {
                        print "<p style='padding:10px;'><b>The cart is empty..</b></p>";
                    } else { ?>
                            ...
                            <table class="table-bordered table">
                                ...
                                <?php foreach ($cart->contents() as $items): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td width="10" style="text-align:right"><?php echo $items['price']; ?></td>
                                        ...
                                        <td width="20"
                                            style="text-align:right"><?php echo $items['subtotal']; ?></td>
                                    </tr>
                        ...
                        <div style="padding: 10px;">
                            <form method="post" action="">
                                <input type="submit" class="btn btn-warning" name="empty" value="Empty Cart"
                                       style="float:right;"/>
                            </form>
