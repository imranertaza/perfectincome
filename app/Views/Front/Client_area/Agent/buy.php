                ...
                ?>
                        ...
                        <table width="100%" class="table" >
                            ...
                            <tr>
                              ...
                              <td>
                                <table  class="table-bordered table con_table" style="text-align: center;">
                    ...
                    endforeach; ?>
                                  <tr>
                                    ...
                                    <td colspan="2">
                                      ...
                                      <input id="myInput" type="text" name="username" class="form-control" onchange="check_spon(this.value)" required>
                                    ...
                                    <td align="right">
                                      <?php echo $this->cart->format_number($this->cart->total()); ?>
                                        <input type="hidden" name="totalamount" value="<?php echo $this->cart->total(); ?>">
                                    </td>
                                  </tr>
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td>&nbsp;</td>
                              <td><input type="submit" class="btn btn-success" name="confirm" value="Confirm" /></td>
                            </tr>
                          </table>
                          </form>
                          <?php } 
