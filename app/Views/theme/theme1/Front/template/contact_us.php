<main id="main" style="margin-top: 100px;">
    <section id="content" class="content">
        <div class="container" data-aos="fade-up">
            <div class="news_feed">
                <h2 class="gradiant">News Feed Contact</h2>
                <ul>
            ...
            <div class="society">
                <h2 class="gradiant">Loihein co society Contact</h2>
            ...
            <div class="pro_list">
                <h2 class="gradiant">Product's list Contact</h2>
                <div class="pro_li">
            ...
            <div class="social_ask">
                <div class="follow_us">
                    <h2 class="gradiant">Follow us Contact</h2>
