...
class balance_receive extends CI_Controller {
	...
	public function index($user_id=0)
	{
		...
		if ($this->m_logged_in == true) {
			...
			$data['query'] = $this->db->get_where('balance_request', array("agent_id"=> $data['ID'], "type"=> "2", "status"=> "Confirm"));
			
			$this->load->view('front/client_area/stockist/balance_receive', $data);
